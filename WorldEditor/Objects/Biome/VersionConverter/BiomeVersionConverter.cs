    ...
    public class BiomeVersionConverter : VersionConverter
    {
        protected override void InitializeConverters()
        {
            ...
            Converters.Add(new BiomeChunkInstanceConverter()
            {
                ...
                Translator = BiomeIdTranslator.FromFile($"Resources\\WorldEditor\\Translators\\Biome\\IdTranslator\\{Version.Snapshot_21w37a}.json")
            });
            Converters.Add(new BiomeRenamerInstanceConverter()
            {
                ...
                Renamer = BiomeRenamer.FromFile($"Resources\\WorldEditor\\Translators\\Biome\\NamespaceRenamer\\{Version.Snapshot_21w40a}.json")
            });
        }
    }
}
